  ...
  <footer id="footer_area">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                    <div class="footer_area_about">
                        ...
                        <p>meand meridian strikes thousand foliage of my
                            trees unknown plants are noticed when I hear
                            the buzz of the little world among the stalks .</p>

                            <div class="copyright_right copyright_left">
                                <ul>
                ...
                <div class="col-lg-3  offset-md-1 col-sm-12 col-12">
                    <div class="footer_navitem_ara">
                        <h3>Support</h3>
                        <div class="nav_item_footer">
                            <ul>
                                <li><h6><strong>Address :</strong>  Patricia C. Amedee 4401 Waldeck
                                    Street Grapevine Nashville, Tx 76051</h6></li>
                                <li><h6> <a href="tel:123-284-2554">Phone: +99 (0) 101 0000 888</a></h6></li>
                                <li><h6> <a href="mailto:info@example.com">Email: Info@yourdomain.com</a></h6></li>
                ...
                <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                    <div class="footer_navitem_ara">
                        ...
                        <div class="footer_twitter_area">
                            ...
                            <p>which bears and sustains us, as it floats around
                                us in an eternity of bliss .</p>
                                <div class="cta_right_side">
                                    <form action="#!" id="subscribe_form">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Your email " required="">
                                            <button class="btn btn_theme1 btn_md" type="submit">Submit</button>
                                        </div>
                                    </form>
                                </div>
                        </div>
                ...
                <div class="co-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright_right">
                        <ul>
                            ...
                            <p>Copyright © 2024 Pet Shop By Averta. All Rights Reserved.</p>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="offcanvas offcanvas-end offcanvas_custom" tabindex="-1" id="offcanvasRight">
